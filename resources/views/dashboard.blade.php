<x-app-layout>
    <div class="grid grid-cols-6 bg-[#f8f8f8]">
        <div class="bg-white shadow-sm h-[640px] px-6 py-5 cursor-pointer">
        ...
        <div class="col-span-5 bg-white shadow-md mx-7 my-7 rounded-md px-5 relative">
            <h1 class="pt-5 text-center text-xl font-semibold">DANH SÁCH NGƯỜI DÙNG</h1>
            <div class="flex justify-end">
                <button class="bg-[#292c45] text-white px-2 py-2 rounded-md mb-5">Thêm User</button>
            </div>
            <table class="w-full">
                <thead>
                    <tr class="bg-[#f3f2f7] text-left text-gray-600 text-[15px]">
                        <th class="border border-gray-300 py-3 text-center">STT</th>
                        <th class="border border-gray-300 px-2">HỌ TÊN</th>
                        <th class="border border-gray-300 px-2">TÊN ĐĂNG NHẬP</th>
                        <th class="border border-gray-300 px-2">EMAIL</th>
                        <th class="border border-gray-300 px-2">NHÓM QUYỀN</th>
                ...
                <tbody class="cursor-pointer">
                    ...
                    <tr class="hover:bg-yellow-100">
                        ...
                        <td class="border border-gray-300 px-2">Mai Trang</td>
