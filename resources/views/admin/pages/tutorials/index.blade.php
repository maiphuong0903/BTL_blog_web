...
<div class="bg-white shadow-md rounded-md px-5 pt-3 pb-20 relative min-h-[calc(100vh-145px)] pb-14">
    <div class="flex justify-end">
        <a class="bg-[#292c45] text-white px-2 py-2 rounded-md my-5" href="{{ route('admin.tutorials.create') }}">Thêm danh mục</a>
    </div>
    <table class="w-full">
        <thead>
        ...
        <tbody class="cursor-pointer">
            ...
            <tr class="hover:bg-yellow-100">
                ...
                <td class="border border-gray-300 px-2"><a href="{{ route('admin.tutorials.detail', $tutorial->id) }}">{{$tutorial->name}}</a></td>
                ...
                <td class="border border-gray-300 px-2">
                    <div class="flex gap-2 justify-center items-center">
                        ...
                        <form action="{{ route('admin.tutorials.destroy', $tutorial->id) }}" method="POST" class="flex items-center">
                            @csrf
                            @method('delete')     
