...
<div class="bg-white shadow-md rounded-md px-5 pt-3 pb-20 relative min-h-[calc(100vh-145px)]">
    <div class="flex justify-end">
        <button class="bg-[#292c45] text-white px-2 py-2 rounded-md my-5">Thêm danh mục</button>
    </div>
    <table class="w-full">
        <thead>
        ...
        <tbody class="cursor-pointer">
            <tr class="hover:bg-yellow-100">
                ...
                <td class="border border-gray-300 px-2">Laravel</td>
                <td class="border border-gray-300 px-2">Framework PHP</td>
                <td class="border border-gray-300 px-2">29/9/2023</td>
            ...
            <tr class="hover:bg-yellow-100">
                ...
                <td class="border border-gray-300 px-2">ReactJS</td>
                <td class="border border-gray-300 px-2">Framework JavaScript</td>
                <td class="border border-gray-300 px-2">29/9/2023</td>
                <td class="border border-gray-300 px-2">
                    <div class="flex gap-2 justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <tr class="hover:bg-yellow-100">
                ...
                <td class="border border-gray-300 px-2">VueJS</td>
                <td class="border border-gray-300 px-2">Framework JavaScript</td>
                <td class="border border-gray-300 px-2">29/9/2023</td>
                <td class="border border-gray-300 px-2">
                    <div class="flex gap-2 justify-center items-center">
