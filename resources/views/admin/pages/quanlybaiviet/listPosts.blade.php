...
@section('content')
<div class="bg-white shadow-md rounded-md px-5 pt-3 relative min-h-[calc(100vh-145px)]">
    <div class="flex justify-end">
        <button class="bg-[#292c45] text-white px-2 py-2 rounded-md my-5">Thêm Bài Viết</button>
    </div>
    <table class="w-full">
        <thead>
        ...
        <tbody class="cursor-pointer">
            <tr class="hover:bg-yellow-100">
                ...
                <td class="border border-gray-300 px-2">Post Kiểm thử in app purchase sử dụng StoreKit với Xcode 12</td>
            ...
            <tr class="hover:bg-yellow-100">
                <td class="border border-gray-300 py-3 text-center">4</td>
                <td class="border border-gray-300 px-2">Post Kiểm thử in app purchase sử dụng StoreKit với Xcode 12</td>
                <td class="border border-gray-300 px-2">Admin</td>
                <td class="border border-gray-300 px-2">29/9/2023</td>
                <td class="border border-gray-300 px-2">
