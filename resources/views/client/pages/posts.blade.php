...
<div class="pb-10 pt-14 lg:mx-8 mx-4">
    <h1 class="text-center font-bold text-2xl text-[#92d3f9]">TẤT CẢ BÀI VIẾT</h1>
    <hr class="mx-auto w-28 border-[#92d3f9] mt-2 mb-10">
    <div class="grid grid-cols-2 md:grid-cols-4 gap-x-7 xl:mx-24">
        <a  href="" class="mb-10 bg-white rounded-lg overflow-hidden shadow-md">
            ...
            <div class="flex flex-col h-[180px] px-2.5 pb-3">
                <div class="py-2 font-semibold text-gray-800 h-[60px] overflow-hidden">Sử dụng Bill Pugh Singleton pattern để tối ưu Java code</div>
